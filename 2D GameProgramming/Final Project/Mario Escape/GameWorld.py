...
def game_init(layer_names):
    global stage1_objects, stage2_objects, stage3_objects, stage4_objects, stage5_objects
    global layer
...
def add(layer_index, object, stage_level=None):
    if (stage_level == 1):
        ...
        stage5_objects[layer_index].append(object)
    else:
...
def clear():
    global curr_objects, title_objects, stage1_objects, stage2_objects, stage3_objects, stage4_objects, stage5_objects
